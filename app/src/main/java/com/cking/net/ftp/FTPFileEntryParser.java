...
/**
 * FTPFileEntryParser defines the interface for parsing a single FtpService file
 * listing and converting that information into an
 * {@link com.cking.net.ftp.FTPFile} instance.
 ...
 *      "com.jinny.net.ftp.parser.EnterpriseUnixFTPFileEntryParser",
 *      ".");
 * </pre>
 *
 ...
 * @see com.cking.net.ftp.FTPFile
 * @see com.cking.net.ftp.FTPClient#listFiles()
 */
public interface FTPFileEntryParser
{
    /**
     * Parses a line of an FtpService server file listing and converts it into a usable
