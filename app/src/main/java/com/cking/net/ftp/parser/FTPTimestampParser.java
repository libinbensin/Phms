...
/**
 * This interface specifies the concept of parsing an FtpService server's
 * timestamp.
 * @since 1.4
 */
public interface FTPTimestampParser {
     ...
     * have been pulled from a longer FtpService listing via the regular expression
     * mechanism
     * @param timestampStr - the timestamp portion of the FtpService directory listing
     * to be parsed
