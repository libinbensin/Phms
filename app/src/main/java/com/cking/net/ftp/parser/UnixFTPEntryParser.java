...
public class UnixFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
    ...
    /**
     * Some Linux distributions are now shipping an FtpService server which formats
    ...
    /**
     * Parses a line of a unix (standard) FtpService server file listing and converts
