 ...
 * @version $Id: NetwareFTPEntryParser.java 1081476 2011-03-14 17:09:59Z sebb $
 * @since 1.5
 */
public class NetwareFTPEntryParser extends ConfigurableFTPFileEntryParserImpl {
    ...
    private static final String TAG = "NetwareFTPEntryParser";
    ...
    public FTPFile parseFTPEntry(String entry) {
        ...
        if (matches(entry)) {
            ...
            //set the name
            f.setName(name.trim());
            Log.i(TAG, "NetwareFTPEntryParser************************************* name ================= " +name);
            //set the size
