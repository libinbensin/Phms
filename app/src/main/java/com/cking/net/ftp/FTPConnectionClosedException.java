 ...
 * unexpected closing of an FtpService connection resulting from a
 * {@link com.cking.net.ftp.FTPReply#SERVICE_NOT_AVAILABLE FTPReply.SERVICE_NOT_AVAILABLE }
 *  response (FtpService reply code 421) to a
 * failed FtpService command.  This exception is derived from IOException and
