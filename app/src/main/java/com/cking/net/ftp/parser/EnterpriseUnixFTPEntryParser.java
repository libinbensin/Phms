...
/**
 * Parser for the Connect Enterprise Unix FtpService Server From Sterling Commerce.
 * Here is a sample of the sort of output line this parser processes:
 *  "-C--E-----FtpService B QUA1I1      18128       41 Aug 12 13:56 QUADTEST"
 * <P><B>
 ...
 * @see com.cking.net.ftp.FTPFileEntryParser FTPFileEntryParser (for usage instructions)
...
public class EnterpriseUnixFTPEntryParser extends RegexFTPFileEntryParserImpl
{
    ...
    private static final String TAG = "EnterpriseUnixFTPEntryParser";
    ...
    /**
     * Parses a line of a unix FtpService server file listing and converts  it into a
