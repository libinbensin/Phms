...
/***
 * FTPReply stores a set of constants for FtpService reply codes.  To interpret
...
public final class FTPReply
{
     ...
     * No further commands can be issued to the FtpService server after a positive
     ...
     * The FtpService server will send a positive completion response on the final
     ...
     * The FtpService server will send a positive intermediate response on the
     ...
     * The FtpService server will send a negative transient response on the
     ...
     * The FtpService server will send a negative permanent response on the
