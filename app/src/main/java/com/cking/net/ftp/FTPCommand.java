...
/**
 * FTPCommand stores a set of constants for FtpService command codes.  To interpret
 * the meaning of the codes, familiarity with RFC 959 is assumed.
 * The mnemonic constant names are transcriptions from the code descriptions
 * of RFC 959.  For those who think in terms of the actual FtpService commands,
 * a set of constants such as {@link #USER  USER } are provided
 * where the constant name is the same as the FtpService command.
 * <p>
 * <p>
 */
...
public final class FTPCommand
{
    ...
    /**
     * Retrieve the FtpService protocol command string corresponding to a specified
     * command code.
     * <p>
     * @param command The command code.
     * @return The FtpService protcol command string corresponding to a specified
     *         command code.
     */
