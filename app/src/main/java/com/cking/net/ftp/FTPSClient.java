...
import com.cking.net.util.Base64;
import com.cking.net.util.SSLContextUtils;
import com.cking.net.util.TrustManagerUtils;

/**
 * FtpService over SSL processing. If desired, the JVM property -Djavax.net.debug=all can be used to
 * see wire-level SSL details.
 *
 * @version $Id: FTPSClient.java 1230368 2012-01-12 02:00:49Z sebb $
 * @since 2.0
 */
...
//    ftps        990/udp    ftp protocol, control, over TLS/SSL
     ...
     * @see com.cking.net.SocketClient#_connectAction_()
     */
    @Override
    ...
    * @see com.cking.net.util.KeyManagerUtils
    */
     ...
     * @param command The FtpService command.
     * @return server reply.
     * @throws IOException If an I/O error occurs while sending the command.
     * @throws SSLException if a CCC command fails
     * @see com.cking.net.ftp.FTP#sendCommand(java.lang.String)
     */
     ...
     * @param command The textual representation of the FtpService command to send.
     * @param arg The arguments to the FtpService command.
     * If this parameter is set to null, then the command is sent with
     * no arguments.
     * @return corresponding to the established data connection.
     * Null is returned if an FtpService protocol error is reported at any point
    ...
    * @see com.cking.net.util.TrustManagerUtils
     */
