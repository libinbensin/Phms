...
public class FTPFile implements Serializable
{
    ...
    /***
     * Set the original FtpService server raw listing from which the FTPFile was
     * created.
     * <p>
     * @param rawListing  The raw FtpService server listing.
     ***/
    ...
    /***
     * Get the original FtpService server raw listing used to initialize the FTPFile.
     * <p>
     * @return The original FtpService server raw listing used to initialize the
     *         FTPFile.
     ***/
