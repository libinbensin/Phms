...
import com.cking.net.ftp.Configurable;
import com.cking.net.ftp.FTPClientConfig;
import com.cking.net.ftp.FTPFileEntryParser;
 ...
 * com.jinny.net.ftp.FTPClient.listFiles()
 * if no other implementation has been specified.
 *
 * @see com.cking.net.ftp.FTPClient#listFiles
 * @see com.cking.net.ftp.FTPClient#setParserFactory
 */
    ...
    implements FTPFileEntryParserFactory
{
     ...
     * commonly used by the FtpService SYST command to identify systems.
     * <p/>
            ...
            try
            {
                ...
                try {
                    ...
                    throw new ParserInitializationException(parserClass.getName()
                        ...
                        + "com.jinny.net.ftp.FTPFileEntryParser.", e);
                } catch (Exception e) {
    ...
    /**
     * Creates an NT FtpService parser: if the config exists, and the system key equals
    ...
    /**
     * Creates an OS400 FtpService parser: if the config exists, and the system key equals
