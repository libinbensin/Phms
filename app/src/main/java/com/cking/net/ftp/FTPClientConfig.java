 ...
 * {@link  com.cking.net.ftp.FTPClient  FTPClient} object and
 * also subordinate objects which it uses.  Any class implementing the
 * {@link  com.cking.net.ftp.Configurable  Configurable }
 * interface can be configured by this object.
 * </p><p>
 * In particular this class was designed primarily to support configuration
 * of FtpService servers which express file timestamps in formats and languages
 * other than those for the US locale, which although it is the most common
 * is not universal.  Unfortunately, nothing in the FtpService spec allows this to
 ...
 * 
 * @since 1.4
 * @see com.cking.net.ftp.Configurable
 * @see com.cking.net.ftp.FTPClient
 * @see com.cking.net.ftp.parser.FTPTimestampParserImpl#configure(FTPClientConfig)
 * @see com.cking.net.ftp.parser.ConfigurableFTPFileEntryParserImpl
 */
public class FTPClientConfig
{
     ...
     * used by an FtpService server in file listings.  This might be particularly
     ...
     * a set of month names used by a hypothetical Icelandic FtpService server might
     ...
     * Experience has shown that many if not most FtpService servers outside the
