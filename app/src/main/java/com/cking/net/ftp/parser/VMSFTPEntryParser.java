...
public class VMSFTPEntryParser extends ConfigurableFTPFileEntryParserImpl
{
    ...
    /**
     * Parses a line of a VMS FtpService server file listing and converts it into a
    ...
    public FTPFile[] parseFileList(java.io.InputStream listStream) throws IOException {
        com.cking.net.ftp.FTPListParseEngine engine = new com.cking.net.ftp.FTPListParseEngine(this);
