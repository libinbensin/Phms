...
public class SfglEtfsPage02 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglEtfsPage0201 page01 = null;
    SfglEtfsPage0202 page02 = null;
    SfglEtfsPage0203 page03 = null;
    SfglEtfsPage0204 page04 = null;
    SfglEtfsPage0205 page05 = null;
    SfglEtfsPage0206 page06 = null;
    SfglEtfsPage0207 page07 = null;
    SfglEtfsPage0208 page08 = null;

    public SfglEtfsPage02(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglEtfsPage02(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglEtfsPage0201(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglEtfsPage0202(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglEtfsPage0203(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglEtfsPage0204(context, beanMap);
        mPageList.add(page04);
        page05 = new SfglEtfsPage0205(context, beanMap);
        mPageList.add(page05);
        page06 = new SfglEtfsPage0206(context, beanMap);
        mPageList.add(page06);
        page07 = new SfglEtfsPage0207(context, beanMap);
        mPageList.add(page07);
        page08 = new SfglEtfsPage0208(context, beanMap);
