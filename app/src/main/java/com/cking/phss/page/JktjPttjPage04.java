...
/**
 * 健康体检普通体检体检第4页
 * com.cking.phss.view.JktjPttjPage04
 * @author Administrator <br/>
 * create at 2012-9-16 上午11:25:10
 */
public class JktjPttjPage04 extends LinearLayout {
    @SuppressWarnings("unused")
    private static final String TAG = "JktjPttjPage04";
...
//    private EditText mJobEdit = null;
     ...
     * @param context
     */
    public JktjPttjPage04(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public JktjPttjPage04(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_pttj_4_layout, this);
