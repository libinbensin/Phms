...
public class SfglEtfsPage01 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglEtfsPage0101 page01 = null;
    SfglEtfsPage0102 page02 = null;
    SfglEtfsPage0103 page03 = null;
    SfglEtfsPage0104 page04 = null;
    SfglEtfsPage0105 page05 = null;

    public SfglEtfsPage01(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglEtfsPage01(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglEtfsPage0101(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglEtfsPage0102(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglEtfsPage0103(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglEtfsPage0104(context, beanMap);
        mPageList.add(page04);
        page05 = new SfglEtfsPage0105(context, beanMap);
