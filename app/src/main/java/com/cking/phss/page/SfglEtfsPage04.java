...
public class SfglEtfsPage04 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglEtfsPage0401 page01 = null;
    SfglEtfsPage0402 page02 = null;
    SfglEtfsPage0403 page03 = null;
    SfglEtfsPage0404 page04 = null;

    public SfglEtfsPage04(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglEtfsPage04(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglEtfsPage0401(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglEtfsPage0402(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglEtfsPage0403(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglEtfsPage0404(context, beanMap);
