...
public class SfglYcfsPage03 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglYcfsPage0301 page01 = null;
    SfglYcfsPage0302 page02 = null;
    SfglYcfsPage0303 page03 = null;
    SfglYcfsPage0304 page04 = null;

    public SfglYcfsPage03(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglYcfsPage03(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglYcfsPage0301(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglYcfsPage0302(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglYcfsPage0303(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglYcfsPage0304(context, beanMap);
