...
/**
 * 健康体检普通体检体检第7页
 * com.cking.phss.view.JktjPttjPage07
 * @author Administrator <br/>
 * create at 2012-9-16 上午11:25:10
 */
public class JktjPttjPage07 extends LinearLayout {
    @SuppressWarnings("unused")
    private static final String TAG = "JktjPttjPage07";
...
//    private EditText mJobEdit = null;
     ...
     * @param context
     */
    public JktjPttjPage07(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public JktjPttjPage07(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_pttj_7_layout, this);
