 ...
 *
 * SfglYcfsPage0104.java
 * classes : com.cking.phss.page.SfglYcfsPage0104
...
/**
 * com.cking.phss.page.SfglYcfsPage0104
 * 
 * @author Wation.Haliyoo <br/>
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglYcfsPage0204 extends MyPage2 {
    private static final String TAG = "SfglYcfsPage0204";
     ...
     * @param beanMap
     */
    public SfglYcfsPage0204(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_ycfs_0204_layout, this);
