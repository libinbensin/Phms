...
public class SfglYcfsPage04 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglYcfsPage0401 page01 = null;
    SfglYcfsPage0402 page02 = null;
    SfglYcfsPage0403 page03 = null;
    SfglYcfsPage0404 page04 = null;

    public SfglYcfsPage04(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglYcfsPage04(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglYcfsPage0401(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglYcfsPage0402(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglYcfsPage0403(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglYcfsPage0404(context, beanMap);
