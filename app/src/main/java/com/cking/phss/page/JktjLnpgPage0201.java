...
public class JktjLnpgPage0201 extends LinearLayout implements IPage {
    private Context mContext = null;
    private Toast mToast = null;
    private Map<String, IBean> beanMap = null;
    private JktjLnpgTestPage02 mLnpgTestPage02 = null;
    JktjLnpgJgxx02 mJktjLnpgJgxx;
    JktjLnpgPage parent;
     ...
     * @param jktjLnpgPage
     */
    public JktjLnpgPage0201(Context context, JktjLnpgPage jktjLnpgPage, Map<String, IBean> beanMap) {
        super(context);
        parent = jktjLnpgPage;
     ...
     * @param attrs
     */
    public JktjLnpgPage0201(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_lnpg_yiyupg_1_layout, this);
    ...
    public void showStartPage() {
        parent.showLnpgPage0201();
    }

    public void showLnpgTestPage() {
        // 第三个参数是人物的性别
        mLnpgTestPage02 = new JktjLnpgTestPage02(mContext, this, ((Jmjbxx) beanMap.get(Jmjbxx.class
                .getName())).getSexCD());
        mLnpgTestPage02.initTopics();
        setView(mLnpgTestPage02);
    }

    public void showLnpgZlpgJgxx(int[] rate) {
        mJktjLnpgJgxx = new JktjLnpgJgxx02(mContext, this, rate, beanMap);
