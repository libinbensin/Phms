...
public class SfglEtfsPage03 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglEtfsPage0301 page01 = null;
    SfglEtfsPage0302 page02 = null;
    SfglEtfsPage0303 page03 = null;
    SfglEtfsPage0304 page04 = null;
    SfglEtfsPage0305 page05 = null;
    SfglEtfsPage0306 page06 = null;
    SfglEtfsPage0307 page07 = null;

    public SfglEtfsPage03(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglEtfsPage03(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglEtfsPage0301(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglEtfsPage0302(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglEtfsPage0303(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglEtfsPage0304(context, beanMap);
        mPageList.add(page04);
        page05 = new SfglEtfsPage0305(context, beanMap);
        mPageList.add(page05);
        page06 = new SfglEtfsPage0306(context, beanMap);
        mPageList.add(page06);
        page07 = new SfglEtfsPage0307(context, beanMap);
