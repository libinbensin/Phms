...
/**
 * 健康体检普通体检体检第6页
 * com.cking.phss.view.JktjPttjPage06
 * @author Administrator <br/>
 * create at 2012-9-16 上午11:25:10
 */
public class JktjPttjPage06 extends LinearLayout implements IPage{
    @SuppressWarnings("unused")
    private static final String TAG = "JktjPttjPage06";
...
//    private EditText mJobEdit = null;
     ...
     * @param context
     */
    public JktjPttjPage06(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public JktjPttjPage06(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_pttj_6_layout, this);
