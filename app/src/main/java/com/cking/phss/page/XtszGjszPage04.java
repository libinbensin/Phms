 ...
 *         create at 2012-9-16 上午11:25:10
 */
public class XtszGjszPage04 extends LinearLayout implements IPage {
    ...
    private int[] viewIds = new int[] { R.id.jktj01CheckBox, R.id.jktj02CheckBox,
            ...
            R.id.jktj07CheckBox, R.id.jktj08CheckBox, R.id.jktj09CheckBox, R.id.jktj10CheckBox };
     ...
     * @param context
     */
    public XtszGjszPage04(Context context, Map<String, IBean> beanMap) {
        super(context);
     ...
     * @param attrs
     */
    public XtszGjszPage04(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_xtsz_gjsz_04_layout, this);

        loadPage(context, this);
    }

    public void loadPage(Context context, ViewGroup viewGroup) {
        String[] ids = ResourcesFactory.listId(mContext, "xtsztjsrxz");
    ...
    public void setValue() {
        ...
        String mksz = appConfig.getTjsrxz();
        String[] items = mksz.split(",");
        if (items != null) {
            String ids = null;
            for (String item : items) {
                String id = ResourcesFactory.findId(mContext, "xtsztjsrxz", item);
                if (ids == null) {
                    ids = id;
                } else {
                    ids += "," + id;
    ...
    public boolean getValue() {
        ...
        appConfig.setTjsrxz(bean.getTagValue());
        return true;
    }
