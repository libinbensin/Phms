 ...
 *
 * SfglYcfsPage0106.java
 * classes : com.cking.phss.page.SfglYcfsPage0106
...
/**
 * com.cking.phss.page.SfglYcfsPage0106
 * 
 * @author Wation.Haliyoo <br/>
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglEtfsPage0206 extends MyPage2 {
    private static final String TAG = "SfglEtfsPage0206";
     ...
     * @param beanMap
     */
    public SfglEtfsPage0206(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_etfs_0206_layout, this);
