 ...
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglYcfsPage0103 extends MyPage2 {
    private static final String TAG = "SfglYcfsPage0103";
     ...
     * @param beanMap
     */
    public SfglYcfsPage0103(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_ycfs_0103_layout, this);
