 ...
 * 
 */
public class SfglNzzReportPage04 extends BasePage {
    private static final String TAG = "SfglNzzReportPage04";
    
    private Context mContext;
    private Toast mToast;
    private Map<String, IBean> beanMap = null;

    public SfglNzzReportPage04(Context context, Map<String, IBean> beanMap) {
        super(context);
     ...
     * @param attrs
     */
    public SfglNzzReportPage04(Context context, AttributeSet attrs) {
        super(context);
        init(context);
    }
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_nzz_bk_04_layout, this);
