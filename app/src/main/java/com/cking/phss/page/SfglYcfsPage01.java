...
public class SfglYcfsPage01 extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglYcfsPage0101 page01 = null;
    SfglYcfsPage0102 page02 = null;
    SfglYcfsPage0103 page03 = null;
    SfglYcfsPage0104 page04 = null;
    SfglYcfsPage0105 page05 = null;
    SfglYcfsPage0106 page06 = null;
    SfglYcfsPage0107 page07 = null;
    SfglYcfsPage0108 page08 = null;
    SfglYcfsPage0109 page09 = null;

    public SfglYcfsPage01(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglYcfsPage01(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    protected void init(final Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_common_layout2,
                this);
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        // 添加页面
        page01 = new SfglYcfsPage0101(context, beanMap);
        mPageList.add(page01);
        page02 = new SfglYcfsPage0102(context, beanMap);
        mPageList.add(page02);
        page03 = new SfglYcfsPage0103(context, beanMap);
        mPageList.add(page03);
        page04 = new SfglYcfsPage0104(context, beanMap);
        mPageList.add(page04);
        page05 = new SfglYcfsPage0105(context, beanMap);
        mPageList.add(page05);
        page06 = new SfglYcfsPage0106(context, beanMap);
        mPageList.add(page06);
        page07 = new SfglYcfsPage0107(context, beanMap);
        mPageList.add(page07);
        page08 = new SfglYcfsPage0108(context, beanMap);
        mPageList.add(page08);
        page09 = new SfglYcfsPage0109(context, beanMap);
