 ...
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglEtfsPage0205 extends MyPage2 {
    private static final String TAG = "SfglEtfsPage0205";
     ...
     * @param beanMap
     */
    public SfglEtfsPage0205(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_etfs_0205_layout, this);
