 ...
 * create at 2012-9-16 上午11:25:10
 */
public class JktjPttjPage17 extends LinearLayout {
...
//    private EditText mJobEdit = null;
     ...
     * @param context
     */
    public JktjPttjPage17(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public JktjPttjPage17(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_pttj_17_layout, this);
