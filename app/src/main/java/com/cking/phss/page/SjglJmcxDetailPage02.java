 ...
 * 
 */
public class SjglJmcxDetailPage02 extends LinearLayout implements IDetailPage {
    ...
    private TextView mBxclText;//本次心率
    private TextView mXcxlText;//下次心率
    ...
    private TextView mBcsylText;//本周摄盐量
    private TextView mXcsylText;//下周摄盐量
    ...
    public SjglJmcxDetailPage02(Context context, Map<String, IBean> beanMap) {
        super(context);
        this.beanMap = beanMap;
        init(context);
    }

    public SjglJmcxDetailPage02(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_sjgl_jmcx_detail_02_layout, this);
        ...
        mBxclText=(TextView)findViewById(R.id.bcxl__text);
        mXcxlText=(TextView)findViewById(R.id.xcxl_text);
        ...
        mBcsylText=(TextView)findViewById(R.id.bcsyl__text);
        mXcsylText=(TextView)findViewById(R.id.xcsyl__text);
    ...
    public void require(String checkSv) {
        ...
        dgxysfjlxxxx15.request.employeeNo = login1.response.employeeNo;
        dgxysfjlxxxx15.request.residentID=jmjbxx.getResidentID();
        dgxysfjlxxxx15.request.visitID=checkSv;
        ...
        BeanUtil.getInstance().getBeanFromWeb(beanList, new BeanUtil.OnResultFromWeb() {
            ...
            public void onResult(List<IDto> listBean, boolean isSucc) {
                if(isSucc||listBean!=null){
                    Dgxysfjlxxxx15 responseDgxysfjlxxxx15=(Dgxysfjlxxxx15)listBean.get(0);
                    if(responseDgxysfjlxxxx15==null||responseDgxysfjlxxxx15.response==null){
                        mToast.setText("查询失败！");
                        mToast.show();
                        return;
                    }
                    updateView(responseDgxysfjlxxxx15.response);
                }
            }
        });
    }
    ...
    private void updateView(Dgxysfjlxxxx15.Response response) {
        ...
        mBxclText.setText(response.BCXL+"");
        mXcxlText.setText(response.XCXL+"");
        ...
        mZzcdText.setText(StringManager.getGxyZz(response.ZZCD)+response.ZZQT);//症状
        ...
        mBcsylText.setText(response.BCSYL+"");
        mXcsylText.setText(response.XCSYL+"");
        ...
        mFzjcText.setText(response.FZJC);
        ...
        SimpleAdapter adapter = new SimpleAdapter(mContext, listMaps, R.layout.list_sjcx_page03_item,
                new String[] { "name", "dosage", "medicineUnit", "usage", "way"
                         }, new int[] { R.id.name_text, R.id.dosage_text,
