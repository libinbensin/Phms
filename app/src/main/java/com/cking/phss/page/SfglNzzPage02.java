 ...
 * create at 2014-8-5 上午11:15:56
 */
public class SfglNzzPage02 extends MyPage2 {
    private static final String TAG = "SfglNzzPage02";
     ...
     * @param beanMap
     */
    public SfglNzzPage02(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_nzz_02_layout, this);
