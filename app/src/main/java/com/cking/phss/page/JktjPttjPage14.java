...
/**
 * 健康体检普通体检体检第14页
 * com.cking.phss.view.JktjPttjPage14
 * @author Administrator <br/>
 * create at 2012-9-16 上午11:25:10
 */
public class JktjPttjPage14 extends LinearLayout {
    @SuppressWarnings("unused")
    private static final String TAG = "JktjPttjPage14";
...
//    private EditText mJobEdit = null;
     ...
     * @param context
     */
    public JktjPttjPage14(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public JktjPttjPage14(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_pttj_14_layout, this);
