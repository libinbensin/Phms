 ...
 * 
 */
public class SfglNzzReportPage03 extends BasePage {
    private static final String TAG = "SfglNzzReportPage03";
    
    private Context mContext;
    private Toast mToast;
    private Map<String, IBean> beanMap = null;

    public SfglNzzReportPage03(Context context, Map<String, IBean> beanMap) {
        super(context);
     ...
     * @param attrs
     */
    public SfglNzzReportPage03(Context context, AttributeSet attrs) {
        super(context);
        init(context);
    }
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_nzz_bk_03_layout, this);
