 ...
 *
 * SfglEtfsPage0102.java
 * classes : com.cking.phss.page.SfglEtfsPage0102
...
/**
 * com.cking.phss.page.SfglEtfsPage0102
 * 
 * @author Wation.Haliyoo <br/>
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglEtfsPage0102 extends MyPage2 {
    private static final String TAG = "SfglEtfsPage0102";
     ...
     * @param beanMap
     */
    public SfglEtfsPage0102(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_etfs_0102_layout, this);
