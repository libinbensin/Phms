 ...
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglEtfsPage0303 extends MyPage2 {
    private static final String TAG = "SfglEtfsPage0303";
     ...
     * @param beanMap
     */
    public SfglEtfsPage0303(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_etfs_0303_layout, this);
