 ...
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglYcfsPage0203 extends MyPage2 {
    private static final String TAG = "SfglYcfsPage0203";
     ...
     * @param beanMap
     */
    public SfglYcfsPage0203(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_ycfs_0203_layout, this);
