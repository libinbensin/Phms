 ...
 *
 * SfglYcfsPage0107.java
 * classes : com.cking.phss.page.SfglYcfsPage0107
...
/**
 * com.cking.phss.page.SfglYcfsPage0107
 * 
 * @author Wation.Haliyoo <br/>
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglEtfsPage0207 extends MyPage2 {
    private static final String TAG = "SfglEtfsPage0207";
     ...
     * @param beanMap
     */
    public SfglEtfsPage0207(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_etfs_0207_layout, this);
