...
public class SfglNzzPage extends MyPage implements ISfglPage {
...
//    public RadioGroup mTabRadios = null;
     ...
     * @param context
     */
    SfglNzzPage01 mNzzPage01 = null;
    SfglNzzPage02 mNzzPage02 = null;
    SfglNzzPage03 mNzzPage03 = null;
    SfglNzzPage04 mNzzPage04 = null;
    SfglNzzPage05 mNzzPage05 = null;

    public SfglNzzPage(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public SfglNzzPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        // init(context);
    }
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        sfglTjLayout.setDisType("0202");

        // getGxyBeanFromDB();
        
        // 添加页面
        mNzzPage01 = new SfglNzzPage01(context, beanMap);
        mPageList.add(mNzzPage01);
        mNzzPage02 = new SfglNzzPage02(context, beanMap);
        mPageList.add(mNzzPage02);
        mNzzPage03 = new SfglNzzPage03(context, beanMap);
        mPageList.add(mNzzPage03);
        mNzzPage04 = new SfglNzzPage04(context, beanMap);
        mPageList.add(mNzzPage04);
        mNzzPage05 = new SfglNzzPage05(context, beanMap);
        mPageList.add(mNzzPage05);
        ...
        if (getValue()) {
            ...
            GlobalUtil.getInstance().setSupplement(new Supplement() {
                ...
                public void protocolToValueSupplement(XmlTag arg0, String arg1) {
                    ...
                    // 白酒或黄酒 啤酒
                    XmlTag bjhhj = (XmlTag) GlobalUtil.globalValueMap.get("脑卒中-生活习惯改变-白酒或黄酒");
                    XmlTag pj = (XmlTag) GlobalUtil.globalValueMap.get("脑卒中-生活习惯改变-啤酒");
                    String id = "";
                    String value = "";
                    String yjl = ""; // 饮酒量
    ...
    public void saveValueToDb() {
        ...
        BeanUtil.getInstance().saveSfglToDb2(beanClassList, operTime, new OnResultSaveToDb() {
            ...
            public void onResult(List<SaveToDbResult> listBean, boolean isSucc) {
                if (isSucc) {
                    ...
                    com.cking.phss.bean.BeanUtil.getInstance().saveLocalRecord(mContext, jmjbxx,
                            result.projectUUID, "43", dataSource, operType, new Date().getTime(),
                            "DB脑卒中随访记录");
                } else {
                            ...
                            if (tag0Value != null) {
                                ...
                                if (tag1Value != null) {
                                    ...
                                    for (String item : items) {
                                        if (item.equals("白酒")) {
                                            GlobalUtil.globalValueMap.put("脑卒中-生活习惯改变-白酒或黄酒",
                                                    new XmlTag("脑卒中-生活习惯改变-白酒或黄酒", item1s[i]));
                                        } else if (item.equals("啤酒")) {
                                            GlobalUtil.globalValueMap.put("脑卒中-生活习惯改变-啤酒",
                                                    new XmlTag("脑卒中-生活习惯改变-啤酒", item1s[i]));
                                        }
                                        i++;
                                    }
                                }
