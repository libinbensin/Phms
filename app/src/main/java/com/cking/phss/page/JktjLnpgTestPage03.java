...
public class JktjLnpgTestPage03 extends LinearLayout implements OnClickListener {
    private JktjLnpgPage0301 mParent = null;
...
//	RelativeGroup mRadioBarAnswer = null;
	 ...
	 * @param context
	 */
    public JktjLnpgTestPage03(Context context, JktjLnpgPage0301 jktjLnpgPage0201, int sexCd) {
		super(context);
        this.mParent = jktjLnpgPage0201;
		this.sexCd=sexCd;
		init(context);
	}
	 ...
	 * @param attrs
	 */
	public JktjLnpgTestPage03(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_lnpg_zhilipg_2_layout, this);
...
//		mRadioBarAnswer = (RelativeGroup) findViewById(R.id.radio_bar_answer);
        ...
        cktpButton = (Button) findViewById(R.id.cktpButton);
        cktpButton.setOnClickListener(new View.OnClickListener() {
            @Override
...
//				});
    ...
    protected void showTupianDialog() {
        final Dialog selectDialog = new Dialog(mContext, R.style.dialog);
        selectDialog.setCancelable(true);
        selectDialog.setContentView(R.layout.dialog_lnpg_zhilipg_tupian_layout);
	...
	protected void updateView(int mTopicIndex) {
        ...
        if (mTopicIndex < tList.size() - 1) {
            cktpButton.setVisibility(View.GONE);
        } else {
            cktpButton.setVisibility(View.VISIBLE);
        }
...
//        }
    ...
    private List<Topic> getTopicList() {
        ...
        for (int i = 0; i < Lnpg.ZHILIPG_QUESTION.length; i++) {
            String question = Lnpg.ZHILIPG_QUESTION[i];// 问题
	...
	private class Topic {
        ...
        public Topic(String question, int answerIndex) {
            ...
            this.selection = new String[] { "正确 ", "错误", "拒绝回答", "说不会做", "文盲" };
			this.answerIndex = answerIndex;
            this.rate = new int[] { 1, 0, 0, 0, 0 };
		}
	}
