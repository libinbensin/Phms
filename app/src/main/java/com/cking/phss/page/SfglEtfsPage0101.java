 ...
 *
 * SfglEtfsPage0101.java
 * classes : com.cking.phss.page.SfglEtfsPage0101
...
/**
 * com.cking.phss.page.SfglEtfsPage0101
 * 
 * @author Wation.Haliyoo <br/>
 *         create at 2014-8-5 上午11:15:56
 */
public class SfglEtfsPage0101 extends MyPage2 {
    private static final String TAG = "SfglEtfsPage0101";
     ...
     * @param beanMap
     */
    public SfglEtfsPage0101(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_etfs_0101_layout, this);
