 ...
 * 
 */
public class SfglYcfsPage extends MyPage implements ISfglPage {
    @SuppressWarnings("unused")
    private static final String TAG = "SfglYcfsPage";
...
//    public static TextView mRegisterIdText = null;
     ...
     * 快速体检的8个子页
     */
    SfglYcfsPage01 page01 = null;
    SfglYcfsPage02 page02 = null;
    SfglYcfsPage03 page03 = null;
    SfglYcfsPage04 page04 = null;

    /**
     * @param context
     */
    public SfglYcfsPage(Context context) {
        super(context);
        mContext = context;
        // init(context);
    }
    ...
    protected void init(final Context context) {
        ...
        inflater.inflate(R.layout.fragment_sfgl_ycfs_layout, this);
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        ...
        page01 = new SfglYcfsPage01(mContext);
        page02 = new SfglYcfsPage02(mContext);
        page03 = new SfglYcfsPage03(mContext);
        page04 = new SfglYcfsPage04(mContext);
        ...
        radiogroup_kstj.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                SfglYcfsPage.sTabRadioId = checkedId;
