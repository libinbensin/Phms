 ...
 * create at 2014-8-5 上午11:15:56
 */
public class SfglNzzPage01 extends MyPage2 {
    private static final String TAG = "SfglNzzPage01";
     ...
     * @param beanMap
     */
    public SfglNzzPage01(Context context, Map<String, IBean> beanMap) {
        super(context);
    ...
    protected void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.fragment_sfgl_nzz_01_layout, this);
