...
/**
 * 健康体检普通体检体检第8页
 * com.cking.phss.view.JktjPttjPage08
 * @author Administrator <br/>
 * create at 2012-9-16 上午11:25:10
 */
public class JktjPttjPage08 extends LinearLayout {
    @SuppressWarnings("unused")
    private static final String TAG = "JktjPttjPage08";
...
//    private EditText mJobEdit = null;
     ...
     * @param context
     */
    public JktjPttjPage08(Context context) {
        super(context);
        init(context);
    }
     ...
     * @param attrs
     */
    public JktjPttjPage08(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.fragment_health_pttj_8_layout, this);
