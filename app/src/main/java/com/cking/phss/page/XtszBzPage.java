 ...
 * 
 */
public class XtszBzPage extends LinearLayout implements IPage {
...
//    public static TextView mRegisterIdText = null;
     ...
     * @param context
     */
    public XtszBzPage(Context context) {
        super(context);
        mContext = context;
     ...
     * @param attrs
     */
    public XtszBzPage(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(final Context context) {
        ...
        inflater.inflate(R.layout.fragment_xtsz_bz_layout, this);
    ...
    public void loadPage(Context context, ViewGroup viewGroup) {
        // 添加页面
        ckbzwdButton = (Button) findViewById(R.id.ckbzwdButton);
        ckbzwdButton.setOnClickListener(new OnClickListener() {
...
//                  onClickHelpItem();
//              }
                File file=new File(Constant.exterNalPath+"/phms/移动随访包使用说明书.pdf");
                if(!file.exists()){
