 ...
 */
public class BcjsbglkHfm01 implements IDto {
	/**
	 * Request
	 */
	@XmlTag(name = "Request")
	...
	static public class Request implements IDto {
		...
		public String operType = "HFM01";

		//@XmlAttribute(name = "!--必填。存盘类型，1：新增存盘 2：编辑存盘-->
        @XmlTag(name = "Type")
		public String type = "";
        // @XmlTag(name = "!--必填。 操作用户ID或代码 -->
        @XmlTag(name = "UserID")
		public String userID = "";
        // @XmlTag(name = "!--个人档案号。如果是新增则无个人档案号（新增时此ID由程序后台生成）-->
	...
	static public class Response implements IDto {
        ...
        // @XmlTag(name = "!--如果保存成功则返回个人档案号、居民姓名 等 -->
        // @XmlTag(name = "!--必填。个人档案号-->
        @XmlTag(name = "ResidentID")
		public String residentID = "";
        // @XmlTag(name = "!--必填。家庭档案号 -->
        @XmlTag(name = "FamilyID")
		public String familyID = "";
        // @XmlTag(name = "!-- 必填。居民姓名 -->
        @XmlTag(name = "ResidentName")
		public String residentName = "";
        // @XmlTag(name = "!--必填。性别代码（单选）。CD:值为代码：0）未知；1）男；2）女；9）未说明性别 -->
        @XmlTag(name = "Sex")
		public BeanCD sex = null;
        // @XmlTag(name = "!--必填。出生日期。格式：yyyy-mm-dd -->
        @XmlTag(name = "BirthDay")
		public String birthDay = "";
        // @XmlTag(name = "!-- 本人电话（宅电） -->
        @XmlTag(name = "Telephone")
        ...
        // @XmlTag(name = "!--必填。个人档案中身高或近期身高，新增管理卡时用。单位：cm，整型 -->
        @XmlTag(name = "Height")
		public String height = "";
        // @XmlTag(name = "!--必填。个人档案中体重或近期体重，新增管理卡时用。单位：kg，浮点 -->
        @XmlTag(name = "Weight")
