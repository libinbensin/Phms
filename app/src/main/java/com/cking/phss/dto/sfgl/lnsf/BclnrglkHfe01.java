 ...
 */
public class BclnrglkHfe01 implements IDto {
	/**
	 * Request
	 */
	@XmlTag(name = "Request")
	...
	static public class Request implements IDto {
		...
		//<!-- 体征-甘油三酯 -->
        @XmlTag(name = "TriglycerideTriglyceride")
	...
	static public class Response implements IDto {
        ...
        @XmlTag(name = "ResidentName")
		public String residentName = "";
		//<!--必填。性别代码（单选）。CD:值为代码：0）未知；1）男；2）女；9）未说明性别 -->
        @XmlTag(name = "Sex")
		public BeanCD sex = null;
