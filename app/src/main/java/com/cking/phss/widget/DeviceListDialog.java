...
public class DeviceListDialog extends Dialog {
    ...
    public static String ACTION_PATCHED_BT = "android.intent.action.ACTION_PATCHED_BT";
     ...
     * @param context
     */
    public DeviceListDialog(Context context, String title) {
        super(context);
        mContext = context;
        setTitle(title);
    }
     ...
     */
    protected DeviceListDialog(Context context, String title, boolean cancelable,
...
//        inflater.inflate(R.layout.device_list, this);  
        ...
        cancelButton.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnDialogResultListener != null) {
                    mOnDialogResultListener.onCancel();
                }
            }
        });
    ...
    private OnItemClickListener mDeviceClickListener = new OnItemClickListener() {
        public void onItemClick(AdapterView<?> av, View v, int arg2, long arg3) {
            ...
            intent.setAction(ACTION_PATCHED_BT);// action与接收器相同
            ...
            dismiss();
            if (mOnDialogResultListener != null) {
                mOnDialogResultListener.onConfirm();
            }
        }
    };
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            // When discovery is finished, change the Activity title
                ...
                if (mNewDevicesArrayAdapter.getCount() == 0) {
                    String noDevices = mContext.getResources().getText(R.string.none_found).toString();
