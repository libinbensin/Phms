...
public class BluetoothServerService {
     ...
     * @param port 
     */
    public BluetoothServerService(Context context, Handler handler, int port, String name,
            int maxChannelSize) {
      ...
      private BluetoothServerSocket getServerSocket(int port) {
        ...
        public void run() {
            ...
            try {
                ...
                /*
                 * if (mPort != -1) { int tmpPort = mPort; //
                 * 因为getServerSocket执行时间较久 mPort = -1; mmServerSocket =
                 * getServerSocket(tmpPort); } else
                 */{
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                BluetoothServerService.this.start();
                return;
            }
